 ...
 */
class getBandeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BandeRepository' shared autowired service.
     *
     * @return \App\Repository\BandeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BandeRepository.php';

        return $container->privates['App\\Repository\\BandeRepository'] = new \App\Repository\BandeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
