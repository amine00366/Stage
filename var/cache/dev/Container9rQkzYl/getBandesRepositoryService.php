 ...
 */
class getBandesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BandesRepository' shared autowired service.
     *
     * @return \App\Repository\BandesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BandesRepository.php';

        return $container->privates['App\\Repository\\BandesRepository'] = new \App\Repository\BandesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
