 ...
 */
class getArmoireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ArmoireRepository' shared autowired service.
     *
     * @return \App\Repository\ArmoireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ArmoireRepository.php';

        return $container->privates['App\\Repository\\ArmoireRepository'] = new \App\Repository\ArmoireRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
